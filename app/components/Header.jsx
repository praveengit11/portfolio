    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                <motion.a initial={{y: 30, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.6, delay: 1}} href="#contact" className='px-10 py-3 rounded-full flex items-center gap-2 bg-red text-white dark:bg-darkTextPrimary'>Contact Me <Image src={assets.github_btn} className='w-4' alt='profile picture' /></motion.a>
            
                <motion.a initial={{y: 30, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.6, delay: 1.2}} href="/sample-resume.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 dark:bg-white dark:text-black'>My Resume <Image src={assets.download_icon} className='w-4' alt='profile picture' /></motion.a>
